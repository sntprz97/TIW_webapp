...
CONSTRAINT FK_PRODUCTOS FOREIGN KEY (idUsuario) REFERENCES USUARIO (email) ON DELETE CASCADE,
...
CONSTRAINT FK_VENDEDORES2 FOREIGN KEY (username) REFERENCES USUARIO (email) ON DELETE CASCADE
);